...
<body>
	...
	<div class="panel-body" style="background-color:#E6EEEE;">
        ...
        <p>Book Title</p>
        <input class="input-lg thumbnail form-control" type="text" name="product_name" id="product_name" autofocus style="width:100%" placeholder=" Book Name" required>
<p>Description</p>
...
<h3>Category</h3>  
<p>Category type</p>
<input type="text" name="product_type" id="product_type" class="form-control" placeholder="history , fiction , horror , thrill ">
<br>
<p>Author Name</p>
<input type="text" name="brand" id="brand" class="form-control" placeholder="Leo Tolstoy ,  Gustave Flaubert">
<br>
<p>Other tags</p>
<input type="text" name="tags" id="tags" class="form-control" placeholder="new book , category name ,  etc">
</div>          
</div>
